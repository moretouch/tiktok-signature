...
class Signer {
    ...
    async init() {
        ...
        await this.page.route("**/*", (route) => {
            return route.request().resourceType() === "script" && !route.request().url().includes('/obj/waf-aiso/')
                ? route.abort()
                : route.continue();
        });
        ...
        //         return;
        //     }
        //     let _body = await response.text();
        //     if (_body.includes("class=\"_wafchallengeid\"")) {
        //         this._wafchallengeid = true;
        //     } else {
        //         this._wafchallengeid = false;
        //     }
        // });
        ...
        if (this._wafchallengeid) {
            console.log("[-] WAF Challenge detected. Allowing all scripts");
        ...
        await this.page.evaluate(() => {
            ...
            window._generateBogus = function _generateBogus(params) {
